...
def parse_file(filepath):
    ...
    Asume el formato de salida proporcionado (QuadraticHash1.txt, QuadraticHash2.txt, QuadraticHash3.txt).
...
if __name__ == "__main__":
    ...
    input_directory = './' # O, por ejemplo, './QuadraticHash/' si solo procesas esa carpeta.
    ...
    txt_files_to_process = ['QuadraticHash1.txt', 'QuadraticHash2.txt', 'QuadraticHash3.txt']
