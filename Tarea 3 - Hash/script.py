...
cpp_files = ["SeparateChaining.cpp", "LinealProbing.cpp", "QuadraticHash.cpp", "DoubleHash.cpp"]
...
cpp_executables = ["SeparateChaining.exe", "LinealProbing.exe", "QuadraticHash.exe", "DoubleHash.exe"]
