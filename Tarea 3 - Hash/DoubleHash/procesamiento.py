...
def parse_file(filepath):
    ...
    Asume el formato de salida proporcionado (DoubleHash1.txt, DoubleHash2.txt, DoubleHash3.txt).
    ...
    for i in range(len(sections)):
        ...
        # Experimento: Uso promedio (Tiempo promedio por operacin)
        # Corregido de 'operaci(o|)n' a 'operacian' y removido el (?: )
...
if __name__ == "__main__":
    ...
    # (ej., 'resultados_doble_hash/'), especifica la ruta aqui.
    input_directory = './' # O, por ejemplo, './DoubleHash/' si solo procesas esa carpeta.
    ...
    # Define explicitamente los archivos a procesar
    txt_files_to_process = ['DoubleHash1.txt', 'DoubleHash2.txt', 'DoubleHash3.txt']
